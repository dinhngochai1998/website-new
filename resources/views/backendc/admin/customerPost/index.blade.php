            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6" style="padding:30px;">
                        <h1 class="float-left mr-5"><i class="nav-icon fas fa-user"></i> CustomerPost</h1>     
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-tools">
                                    <div class="input-group input-group-sm" style="width: 150px;">
                                        <input type="text" data-url="{{ route('userpost.select') }}" name="table_search" id="search-user" class="form-control float-right" placeholder="Search">
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody id="list-user">
                                       @include("backendc.admin.customerPost.ajax.search")
                                    </tbody>
                                </table>
                            </div>
                            <!-- /.card-body -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <div class="dataTables_paginate paging_simple_numbers float-right" id="example2_paginate">
                            @include('backendc.components.pagination', ['paginator' => $getAllCustomerPost])
                        </div>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
